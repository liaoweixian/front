...
function CRUD(options) {
  ...
  const methods = {
    ...
    toQuery() {
      crud.page.page = 1
      crud.refresh()
      console.log(JSON.stringify(crud.query))
      console.log(JSON.stringify(crud.params))
      // Object.keys(query).forEach(key => {
      //   query[key] = defaultQuery[key]
      //   // console.log(query[key])
      //   // console.log("----",defaultQuery[key])
      //   crud.query[key] = defaultQuery[key]
      //   console.log(crud.query[key])
      // })
      // Object.keys(crud.params).forEach(key => {
      //   // query[key] = defaultQuery[key]
      //   // console.log(query[key])
      //   // console.log("----",defaultQuery[key])
      //   crud.params[key] = defaultQuery[key]
      //   console.log(crud.params[key])
      // })
    },
    // 刷新
    refresh() {
    ...
    resetQuery(toQuery = true) {
      ...
      // console.log("+++",JSON.stringify(curd.query))
      Object.keys(crud.params).forEach(key => {
        // query[key] = defaultQuery[key]
        // console.log(query[key])
        // console.log("----",defaultQuery[key])
