<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column v-if="columns.visible('dept')" prop="dept" align="center" label="所属部门">
      ...
      <el-table-column v-if="columns.visible('createTime')" prop="createTime" align="center" label="创建日期">
        <template slot-scope="scope">
