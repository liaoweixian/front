      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17" style="margin-bottom: 10px">
        <el-card class="box-card" shadow="never">
          ...
          <el-table ref="table" v-loading="crud.loading" highlight-current-row style="width: 100%;" :data="crud.data" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
            ...
            <el-table-column v-if="columns.visible('name')" prop="name" align="center" label="名称" />
            <el-table-column v-if="columns.visible('dataScope')" prop="dataScope" align="center" label="数据权限" />
            <el-table-column v-if="columns.visible('permission')" prop="permission" align="center" label="角色权限" />
            <el-table-column v-if="columns.visible('level')" prop="level" align="center" label="角色级别" />
            <el-table-column v-if="columns.visible('remark')" :show-overflow-tooltip="true" prop="remark" align="center" label="描述" />
            <el-table-column v-if="columns.visible('createTime')" :show-overflow-tooltip="true" width="135px" prop="createTime" align="center" label="创建日期">
