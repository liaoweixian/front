      ...
      <el-container class="dashboard-container">
            ...
            <el-main>
                ...
                <el-row class="f-ajc main-title-el">
                  <el-col span="6" class=" f-f1  f-ajc main-col-1"> 库门号：{{doors[0].name}} </el-col>
                ...
                <el-row :gutter="30" c>
                  ...
                  <!-- 中间 -->
                  <el-col :span="10"> <div class=" f-ajc zzz-d"> 
                  ...
                  <el-col :span="8"> <div class="grid-content bg-purple">
                    <!-- 上面 -->
                        <div class="f-ajc zzs-d"> <span >Helper</span></div>
                        <!-- 下面 -->
                        <div class="f-ajc zzsx"> 
                ...
                <el-row class="bottom-row ">
                  <!-- 左边 -->
                  <el-col :span="12" ><div class="bottom-row-left">
                    <!-- 上面 -->
                    <div class="f-ajc">
                        <!-- 左边 -->
